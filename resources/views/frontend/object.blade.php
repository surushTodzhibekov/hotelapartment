...
<div class="container-fluid places">
        ...
        <div class="tab-pane fade" id="people">
            ...
            <ul class="list-inline">
                @foreach( $object->users as $user) 
                    <li><a href="{{ route('person',['id'=>$user->id]) }}"><img title="{{ $user->FullName /* Lecture 16 */ }}" class="media-object img-responsive" width="50" height="50" src="{{ $user->photos->first()->path ?? $placeholder  }}" alt="..."> </a></li>
    ...
    <div class="collapse" id="collapseExample">
        <div class="well">
            ...
            <form method="post" class="form-horizontal" action="{{ route('addComment',['object_id'=>$object->id, 'App\TouristObject']) }}">
                <fieldset>
    ...
    <section>
        ...
        @foreach($object->articles as $article) 
            <div class="articles-list">
                ...
                <p>{{ str_limit($article->content,250) }}  </p> <a href="{{ route('article',['id'=>$article->id]/* Lecture 22 */) }}">More</a>
            </div>
